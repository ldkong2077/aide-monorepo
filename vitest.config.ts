 ...
 *
 *   - Global floor: 15% lines / 15% statements, 80% branches,
 *     65% functions. The floor reflects the current state of the
 *     monorepo (most of `@aide/graph`'s tree-sitter extraction
