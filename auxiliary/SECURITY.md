...
[releases page](https://github.com/aide-dev/aide/releases) for what
...
[Open a private advisory](https://github.com/aide-dev/aide/security/advisories/new)
...
send a PGP-encrypted email to **security@aide-dev.com** with the
...
- Affected package(s) and version(s) (e.g. `@aide/guard@1.0.0`)
...
- **GitHub Security Advisories** (primary):
  [github.com/aide-dev/aide/security/advisories](https://github.com/aide-dev/aide/security/advisories)
...
repository. The `@aide/cli` and `@aide/guard` packages also publish
