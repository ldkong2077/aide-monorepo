...
GitHub repository, the issue tracker, pull request discussions, the
`@aide/*` Discord / Slack channels (when they exist), and any other
forum or channel where the AIDE community gathers. It also applies when
...
**conduct@aide.dev** (or, for security issues, see `SECURITY.md`).
...
## Reporting a non-security violation

If the violation is **not** a security issue (see `SECURITY.md` for
vulnerability reports), email **conduct@aide.dev** with:

- A description of what happened
- Links / screenshots / logs that document the incident
- Whether you want the report to be kept confidential

A maintainer will respond within 72 hours. Confidentiality is honoured
by default unless disclosure is required by law.
