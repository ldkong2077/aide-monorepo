...
`kustomization.yaml` pins the image to `ghcr.io/ldkong2077/aide-monorepo:1.0.0`.
Override with kustomize:

```bash
cd deploy/k8s/templates
kustomize edit set image \
  ghcr.io/ldkong2077/aide-monorepo=ghcr.io/ldkong2077/aide-monorepo:v1.2.3
kubectl apply -k .
```
...
cd deploy/k8s/templates
kustomize edit set image ghcr.io/ldkong2077/aide-monorepo:ghcr.io/ldkong2077/aide-monorepo:v1.2.3
